		...
		<Wrapper>
			<OptimalLineLength>
				...
				<P>
					...
					freedom of flying <Emoji name="airplane" />, he craved to
				...
				<P>
					...
					<Emoji name="motorcycle" />, purchased his first computer{" "}
					<Emoji name="laptop-computer" /> and started to learn
					coding.
				</P>
				<P>
					...
					the same – he loves <Emoji name="red-heart" /> to give users
